        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          <div class="col">
            <div class="card shadow-sm">
                <img src="foto_produk/<?=$data_buku['foto']?>" class="card-img-top" width="100px" height="600px"</img>
                <div class="card-body">
                <p class="card-text" style="height: 40px"><b><?=$data_buku['nama_buku']?></b></p>
                <p class="card-text" style="height: 200px"><?=$data_buku['deskripsi']?></p>
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    <a href="pinjam_buku.php?id_buku=<?=$data_buku['id_buku']?>" type="button" class="btn btn-sm btn-outline-secondary">Pinjam</a>
                    </div>
