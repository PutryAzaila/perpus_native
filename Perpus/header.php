<?php 
session_start();
    if($_SESSION['status_login']!=true){ //mempertahankan informasi pada halaman web yang berbeda
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="histori_peminjaman_user.php">Transaksi</a>
            </li>
            <li class="nav-item">
