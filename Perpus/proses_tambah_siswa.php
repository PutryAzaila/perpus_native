...
if($_POST){
    ...
    if(empty($nama_siswa)){
        ...
        if($insert){
            echo "<script>alert('Sukses menambahkan siswa');location.href='tampil_siswa_admin.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan siswa');location.href='tampil_siswa_admin.php';</script>";
        }
    }
}
?>