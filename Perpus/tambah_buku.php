...
<body>
            ...
            <div class="card-body">
                <form method="POST" action="proses_tambah_buku.php" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="deskripsi" row="3" placeholder="Masukkan Deskripsi" required></textarea>
                    </div>
                    <div class="mb-3">
 ...
 <!-- enctype = supaya fotonya bisa di ambil datanya, saat mengupload foto
 method post =agar url nya tidak tampil -->