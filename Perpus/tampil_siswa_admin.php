    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h1>DATA SISWA</h1>
                <form method="POST" action="tampil_siswa_admin.php" class="d-flex">
            ...
            <table class="table">
                ...
                <?php
                    ...
                    if (isset($_POST['cari'])) {
                        $cari = $_POST['cari'];
                        $query_siswa = mysqli_query($conn, "select * from siswa s join kelas k on s.id_kelas = k.id_kelas where s.id_siswa = '$cari' or s.nama_siswa like '%$cari%' or s.alamat like '%$cari%' or s.username like '%$cari%'");
                    }
                    else{
                        $query_siswa = mysqli_query($conn, "select * from siswa s join kelas k on s.id_kelas = k.id_kelas");
                        $no=0;
                    }
