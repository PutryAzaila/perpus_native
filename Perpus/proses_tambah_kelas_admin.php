...
if($_POST){
    ...
    if(empty($nama_kelas)){
        ...
        if($insert){
            echo "<script>alert('Sukses menambahkan kelas');location.href='tampil_kelas_admin.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan kelas');location.href='tampil_kelas_admin.php';</script>";
        }
    }
}
?>